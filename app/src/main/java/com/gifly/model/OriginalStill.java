...
public class OriginalStill implements Parcelable {
    ...
    public static final Creator<OriginalStill> CREATOR = new Creator<OriginalStill>() {
        @Override
        public OriginalStill createFromParcel(Parcel source) {
            return new OriginalStill(source);
        }
