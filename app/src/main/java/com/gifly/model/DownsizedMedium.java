...
public class DownsizedMedium implements Parcelable {
    ...
    public static final Creator<DownsizedMedium> CREATOR = new Creator<DownsizedMedium>() {
        @Override
        public DownsizedMedium createFromParcel(Parcel source) {
            return new DownsizedMedium(source);
        }
