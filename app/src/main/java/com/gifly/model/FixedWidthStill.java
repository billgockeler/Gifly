...
public class FixedWidthStill implements Parcelable {
    ...
    public static final Creator<FixedWidthStill> CREATOR = new Creator<FixedWidthStill>() {
        @Override
        public FixedWidthStill createFromParcel(Parcel source) {
            return new FixedWidthStill(source);
        }
