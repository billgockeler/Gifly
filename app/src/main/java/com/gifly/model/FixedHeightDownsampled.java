...
public class FixedHeightDownsampled implements Parcelable {
    ...
    public static final Creator<FixedHeightDownsampled> CREATOR = new Creator<FixedHeightDownsampled>() {
        @Override
        public FixedHeightDownsampled createFromParcel(Parcel source) {
            return new FixedHeightDownsampled(source);
        }
