...
public class DownsizedSmall implements Parcelable {
    ...
    public static final Creator<DownsizedSmall> CREATOR = new Creator<DownsizedSmall>() {
        @Override
        public DownsizedSmall createFromParcel(Parcel source) {
            return new DownsizedSmall(source);
        }
