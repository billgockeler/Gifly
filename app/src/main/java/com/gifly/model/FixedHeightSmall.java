...
public class FixedHeightSmall implements Parcelable {
    ...
    public static final Creator<FixedHeightSmall> CREATOR = new Creator<FixedHeightSmall>() {
        @Override
        public FixedHeightSmall createFromParcel(Parcel source) {
            return new FixedHeightSmall(source);
        }
