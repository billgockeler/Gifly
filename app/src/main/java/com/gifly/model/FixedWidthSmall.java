...
public class FixedWidthSmall implements Parcelable {
    ...
    public static final Creator<FixedWidthSmall> CREATOR = new Creator<FixedWidthSmall>() {
        @Override
        public FixedWidthSmall createFromParcel(Parcel source) {
            return new FixedWidthSmall(source);
        }
