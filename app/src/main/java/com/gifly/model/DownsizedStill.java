...
public class DownsizedStill implements Parcelable {
    ...
    public static final Creator<DownsizedStill> CREATOR = new Creator<DownsizedStill>() {
        @Override
        public DownsizedStill createFromParcel(Parcel source) {
            return new DownsizedStill(source);
        }
